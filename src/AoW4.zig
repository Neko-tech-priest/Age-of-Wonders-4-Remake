...
{
    const vertShaderModule: VulkanInclude.VkShaderModule = VkPipeline.createShaderModule("shaders/AoW4_P3N3U2C4T3.vert.spv");
    const fragShaderModule: VulkanInclude.VkShaderModule = VkPipeline.createShaderModule("shaders/AoW4_Diffuse.frag.spv");
