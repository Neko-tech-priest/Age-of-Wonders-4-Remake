...
pub const DiffuseMaterial = packed struct
{
    ...
    pub fn Create_DiffuseMaterial_VkDescriptorSet(self: *DiffuseMaterial, descriptorSetLayout: VulkanInclude.VkDescriptorSetLayout, descriptorPool: VulkanInclude.VkDescriptorPool) void
    {
...
pub fn Create_DiffuseMaterial_VkDescriptorSetLayout(descriptorSetLayout: *VulkanInclude.VkDescriptorSetLayout) void
{
...
pub fn Create_DiffuseMaterial_VkDescriptorPool(descriptorPool: *VulkanInclude.VkDescriptorPool, texturesCount: u32) void
{
...
pub fn Create_P3N3U2C4T3_Pipeline(descriptorSetLayout: VulkanInclude.VkDescriptorSetLayout, pipelineLayout: *VulkanInclude.VkPipelineLayout, pipeline: *VulkanInclude.VkPipeline) !void
{
    const vertShaderModule: VulkanInclude.VkShaderModule = try VkPipeline.createShaderModule("shaders/AoW4_P3N3U2C4T3.vert.spv");
    const fragShaderModule: VulkanInclude.VkShaderModule = try VkPipeline.createShaderModule("shaders/AoW4_Diffuse.frag.spv");
