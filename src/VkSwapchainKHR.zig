...
// 	print("{d}\n{d}\n\n", .{WindowGlobalState._windowExtent.width, WindowGlobalState._windowExtent.height});
...
pub fn createDepthResources() void
{
	...
	VkImage.createVkImageView(VulkanGlobalState._depthImage, VulkanGlobalState._depthFormat, VulkanInclude.VK_IMAGE_ASPECT_DEPTH_BIT, &VulkanGlobalState._depthImageView);
}
